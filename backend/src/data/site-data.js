// Static site configuration. Editable collections are stored in CONTENT_DB.
export const siteData = {
  "aboutPage": {
    "eyebrow": "About Us",
    "title": "We Build Trust That Drives Growth.",
    "introduction": "LIDA is more than an agency. We are a partner in growth. We help ambitious organizations strengthen their positioning, earn trust, attract customers, and create measurable commercial value through strategy-led execution.",
    "impact": [
      {
        "value": "100+",
        "label": "Businesses Supported",
        "description": "Partnering with ambitious organizations across multiple industries to strengthen positioning, build trust, and support commercial growth."
      },
      {
        "value": "360°",
        "label": "Growth Support",
        "description": "From strategy and positioning to creative execution and customer acquisition, we support businesses at every stage of growth."
      },
      {
        "value": "15+",
        "label": "Industries Served",
        "description": "Delivering solutions across finance, real estate, technology, engineering, hospitality, manufacturing, professional services, and more."
      },
      {
        "value": "10+",
        "label": "Years of Experience",
        "description": "A decade of helping businesses solve communication, branding, and market growth challenges through strategy-led execution."
      }
    ],
    "reasons": [
      {
  ...
  "industries": [
    ...
    {
      "name": "Finance, Banking & Blockchain",
  ...
  "partners": [
    {
      "name": "Client 33",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-33.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-34.png"
    },
    {
      "name": "Client 35",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-35.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-36.png"
    },
    {
      "name": "Client 37",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-37.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-38.png"
    },
    {
      "name": "Client 39",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-39.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-40.png"
    },
    {
      "name": "Client 41",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-41.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-42.png"
    },
    {
      "name": "Client 43",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-43.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-44.png"
    },
    {
      "name": "Client 45",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-45.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-46.png"
    },
    {
      "name": "Client 47",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-47.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-48.png"
    },
    {
      "name": "Client 49",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-49.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-50.png"
    },
    {
      "name": "Client 51",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-51.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-52.png"
    },
    {
      "name": "Client 53",
      "logo": "/assets/img/home-1/Lida Client Logos (Monochromatic)-53.png",
      "logoHover": "/assets/img/home-1/Lida Client Logos (Monochromatic)-54.png"
    }
  ],
  "stats": [
    {
      ...
      "value": "100",
      "suffix": "+",
      "desc": "Helping ambitious businesses strengthen their position, build trust and grow with confidence."
    },
    {
      "label": "End-to-End Growth Support",
      "value": "01",
      "suffix": "",
      "desc": "From strategy and positioning to branding, marketing and execution, we bring the right support together around your goals."
    },
    {
      "label": "Industries Served",
      "value": "15",
      "suffix": "+",
      "desc": "Experience across finance, real estate, technology, engineering, hospitality, professional services and more."
    },
    {
      "label": "Years of Experience",
      "value": "10",
      "suffix": "+",
      "desc": "Over a decade of helping businesses communicate clearly, reach the right people and create stronger market opportunities."
    }
  ],
  "testimonials": [
    {
