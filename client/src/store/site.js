...
export const services = [
  ...
  },
  {
    ...
    approachHeading: 'Attract the right customers with marketing built around your business goals.',
    approachBody: 'We design and execute integrated marketing campaigns focused on attracting and converting the right customers. From strategy and creative development to media planning, paid advertising and performance tracking, every campaign is built around clear business goals and measurable outcomes.',
  ...
  },
  {
    ...
    approachHeading: 'Turn new customers into loyal ones through better communication and experience.',
    approachBody: 'Winning a customer is only the beginning. We help businesses develop the communication strategies, onboarding experiences and engagement frameworks that turn new customers into loyal, long-term ones. We identify the gaps in the customer journey and build the tools and messaging needed to close them.',
  ...
  },
  {
    ...
    approachHeading: 'Manage your public narrative and protect what your brand has earned.',
    approachBody: 'We manage your public narrative with precision. Our approach builds proactive media relationships, positions your leadership as credible voices in your industry and ensures your organisation is prepared to communicate effectively across every situation — from launches and milestones to sensitive reputational moments.',
  ...
  },
  {
    ...
    approachHeading: 'Build the kind of presence that opens doors and creates opportunity.',
    approachBody: 'We help business leaders and organisations build a market presence that earns credibility, attracts the right attention and creates commercial opportunity. From executive profile development and thought leadership to investor-facing messaging and corporate communications, we position leaders and organisations to be taken seriously.',
  ...
  },
  {
    ...
    approachHeading: 'Create work that communicates clearly and moves your audience to act.',
    approachBody: 'We produce content and creative work that does more than look good — it builds credibility, communicates value and supports commercial objectives. From brand storytelling and copywriting to photography, video and design, we create the assets your business needs to show up with confidence across every channel.',
  ...
  },
  {
    ...
    approachHeading: 'Build a digital presence your audience can find, trust and act on.',
    approachBody: 'We develop digital strategies and manage the channels that matter most for your business. From website strategy and social media management to digital advertising and search visibility, we ensure your brand is present, credible and engaging wherever your audience is looking.',
  ...
  },
  {
    ...
    approachHeading: 'Design experiences that reflect your brand and move your audience.',
    approachBody: 'We plan and deliver events and brand experiences that go beyond logistics. From product launches and corporate events to stakeholder engagements and experiential marketing activations, we design experiences that reflect your brand, engage your audience and support your commercial objectives.',
  ...
  },
  {
    ...
    approachHeading: 'Enter new markets with the right strategy, positioning and local insight.',
    approachBody: 'We help businesses successfully enter and grow within new markets — whether expanding into Nigeria, establishing a presence across Africa or reaching new audience segments. We combine local market insight, strategic positioning, stakeholder engagement and communications execution to give your market entry the best possible foundation.',
